    ...
    <div class="contenedor-anuncios">
        <div class="anuncio separador">
            ...
            <div class="contenido-anuncio">
                <h3 class="">Casa de Lujo del Lago</h3>
                ...
                <a href="entrada.html" class="boton-amarillo-block">Ver Propiedad</a>
        ...
        <div class="anuncio">
            ...
            <div class="contenido-anuncio">
                <h3 class="">Casa Terminado de Lujo</h3>
                <p>Casa en el lago con excelente vista, acabado de lujo a un excelente precio</p>
                <p class="precio">$3,000,000</p>
